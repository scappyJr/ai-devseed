...
# 🏷️ AI DevSeed - GitHub Labels Setup Script
#
# Usage:
...
echo "🌱 Setting up AI DevSeed GitHub labels..."
echo ""

# ===== Type =====
echo "📌 Type labels..."
gh label create "type/bug" --color "D73A4A" --description "Something isn't working" --force
gh label create "type/feature" --color "A2EEEF" --description "New feature or template" --force
...
gh label create "template/base" --color "FFE5D9" --description "Base/generic template" --force
gh label create "template/mobile-rn" --color "FF8C61" --description "React Native template" --force
gh label create "template/web-react" --color "4FC3F7" --description "Web React template" --force
